...
public class BallSpawner
{
    ...
    {
        BallSpawner.CreateBall(world, new Vec2Int(0, 0), new Vector2(15, 15), assets.ChristmasWinking);
        BallSpawner.CreateBall(world, new Vec2Int(180, 0), new Vector2(15, 15), assets.ChristmasWinking);
        BallSpawner.CreateBall(world, new Vec2Int(360, 0), new Vector2(15, 15), assets.ChristmasWinking);
        BallSpawner.CreateBall(world, new Vec2Int(800, 600), new Vector2(-15, -15), assets.Handshake);
    ...
    public static void CreateBall(World world, Vec2Int position, Vector2 velocity, Texture2D? texture,
